...
def  test_add_reminder_scenario_1(reminder_handler):
    diffs = reminder_mocker(reminder_handler.start, path="/home/hamza/task-scheduler/tests/test_reminders/test_reminders_add_reminders/add_reminder_scenario_1.txt")
